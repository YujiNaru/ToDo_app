...
Route::group(['middleware' => 'auth'], function() {
    ...
    Route::group(['middleware' => 'can:view,folder'], function() {
        ...
        Route::get('/folders/{id}/tasks/{task}/edit', 'App\Http\Controllers\TaskController@showEditForm')->name('tasks.edit');
        Route::post('/folders/{id}/tasks/{task}/edit', 'App\Http\Controllers\TaskController@edit');
    });
});
